---
layout: post
title: "AI 에이전트와 함께하는 실시간 서비스 모니터링"
description: "GA, Cloud Run 로그, DB를 넘나드는 질문 하나로 서비스 상태를 파악하는 방법"
date: 2026-04-29
...
![시나리오1 흐름도](../images/20260429/blog-scenario1.png)
...
![시나리오2 흐름도](../images/20260429/blog-scenario2.png)
